...
// Optional metrics service interface
// // export interface MetricsService {
// //   setRedisDuration(operation: string, duration: number): void;
// // }

/**
 * A lightweight Redis cache service that wraps ioredis operations with
 * error handling, JSON (de)serialization, and (optional) metrics logging.
 */
